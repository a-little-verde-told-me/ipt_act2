...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            ['name' => 'Blush Dreams', 'category' => 'Bouquet', 'price' => 1199.00, 'description' => 'Pink roses with baby’s breath.', 'image_url' => 'Blush Dreams.jpg'],
            ['name' => 'Sunshine Cheer', 'category' => 'Bouquet', 'price' => 1099.00, 'description' => 'Sunflowers and daisies mix.', 'image_url' => 'Sunshine Cheer.jpg'],
            ['name' => 'Elegant White', 'category' => 'Bouquet', 'price' => 1399.00, 'description' => 'White lilies and roses.', 'image_url' => 'Elegant White.jpg'],
            ['name' => 'Pastel Mix', 'category' => 'Bouquet', 'price' => 999.00, 'description' => 'Soft tulips and carnations.', 'image_url' => 'Pastel Mix.jpg'],
            ['name' => 'Spring Garden', 'category' => 'Bouquet', 'price' => 1499.00, 'description' => 'Seasonal mixed blooms.', 'image_url' => 'Spring Garden.jpg'],
            ['name' => 'Royal Orchid', 'category' => 'Bouquet', 'price' => 1699.00, 'description' => 'Orchid centerpiece bouquet.', 'image_url' => 'Royal Orchid.jpg'],
            ['name' => 'Gerbera Joy', 'category' => 'Bouquet', 'price' => 999.00, 'description' => 'Gerbera daisies with greenery.', 'image_url' => 'Gerbera Joy.jpg'],
            ['name' => 'Love in Bloom', 'category' => 'Bouquet', 'price' => 1349.00, 'description' => 'Red and white roses.', 'image_url' => 'Love in Bloom.jpg'],
            ['name' => 'Rustic Charm', 'category' => 'Bouquet', 'price' => 999.00, 'description' => 'Daisies with eucalyptus.', 'image_url' => 'Rustic Charm.jpg'],
            ['name' => 'Peachy Glow', 'category' => 'Bouquet', 'price' => 1199.00, 'description' => 'Peach roses and mums.', 'image_url' => 'Peachy Glow.jpg'],
            ['name' => 'Classic Sympathy', 'category' => 'Bouquet', 'price' => 1299.00, 'description' => 'White lilies and carnations.', 'image_url' => 'Classic Sympathy.jpg'],
            ['name' => 'Stargazing Bloom', 'category' => 'Bouquet', 'price' => 1599.00, 'description' => 'Elegant stargazer lilies with roses.', 'image_url' => 'Stargazing Bloom.jpg'],
        ];

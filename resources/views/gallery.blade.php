    ...
    <div class="gallery-grid">
        @foreach($events as $event)
            <div class="event-card" data-category="{{ $event['category'] }}" data-name="{{ strtolower($event['name']) }}">
                <button class="event-link" type="button" data-image="{{ asset('images/gallery/'.$event['image']) }}" data-title="{{ $event['name'] }}">
                    <img class="event-image" src="{{ asset('images/gallery/'.$event['image']) }}" alt="{{ $event['name'] }}">
                </button>
